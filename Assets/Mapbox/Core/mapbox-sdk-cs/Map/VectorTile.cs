...
namespace Mapbox.Map
{
	...
	public sealed class VectorTile : Tile, IDisposable
	{
		...
		{
			//UnityEngine.Debug.Log("Style is ...."+styleId);
			...
			else
			{
				...
				UnityEngine.Debug.Log("Style is ...."+_optimizedStyleId);
		...
		{
			UnityEngine.Debug.Log("data layers ...."+this.data.LayerNames());
		...
		{
                        UnityEngine.Debug.Log("layerName......."+layerName);
		...
		{
            //UnityEngine.Debug.Log("......."+tilesetId+"......"+Id);
		...
		internal override bool ParseTileData(byte[] data)
		{
			try
			{
				...
				//UnityEngine.Debug.Log("decompressed is...");
