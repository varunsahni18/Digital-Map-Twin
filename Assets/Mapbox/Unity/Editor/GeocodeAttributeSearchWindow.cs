	...
	public class GeocodeAttributeSearchWindow : EditorWindow
	{
		...
		public static void Open(SerializedProperty property, object objectToUpdate = null)
		{
			...
			if (objectToUpdate != null)
			{
				...
				UnityEngine.Debug.Log("window._objectToUpdate"+window._objectToUpdate);
			}
				...
				if (_features.Count > 0)
				{
					...
					for (int i = 0; i < _features.Count; i++)
					{
						...
						if (GUILayout.Button(buttonContent))
						{
							...
							UnityEngine.Debug.Log("_coordinateProperty.stringValue .."+_coordinateProperty);
							UnityEngine.Debug.Log("_objectToUpdate .."+_objectToUpdate);
