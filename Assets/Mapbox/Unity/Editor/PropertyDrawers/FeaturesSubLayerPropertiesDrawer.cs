namespace Mapbox.Editor
{
	...
	public class FeaturesSubLayerPropertiesDrawer
	{
		...
		public void DrawUI(SerializedProperty property)
		{
            ...
            // UnityEngine.Debug.Log("tileJSONData is..."+tileJSONData);
			...
			//UnityEngine.Debug.Log("Source val is.."+sourceTypeValue);
			switch (sourceTypeValue)
			{
				case VectorSourceType.D3VStyle:
					var sourcePropertyValue = MapboxDefaultVector.GetParameters(sourceTypeValue);
                                        //UnityEngine.Debug.Log("Source val is.."+sourcePropertyValue.Id);
		...
		{
			//UnityEngine.Debug.Log("sourceType is.."+sourceType+"layerProperty is.."+layerProperty+"property is.."+property);
			var subLayerCoreOptions = layerProperty.FindPropertyRelative("coreOptions");
			...
			//UnityEngine.Debug.Log("Vector tiles"+layerDisplayNames);
		...
		{
			//UnityEngine.Debug.Log("........................"+sourceTypeValue);
		...
		public void DrawLayerName(SerializedProperty property, List<string> layerDisplayNames)
		{
			...
			//UnityEngine.Debug.Log("layerString is.."+layerString);
			...
			//UnityEngine.Debug.Log("parsedString is...."+parsedString);
