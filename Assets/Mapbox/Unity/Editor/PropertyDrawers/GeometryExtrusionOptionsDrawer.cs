namespace Mapbox.Editor
{
	...
	public class GeometryExtrusionOptionsDrawer : PropertyDrawer
	{
		...
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
			...
			var displayNameso = extrusionTypeProperty.enumDisplayNames;
			List<string> displayNames = displayNameso.ToList();
			/*if((( property.FindPropertyRelative("_selectedLayerName").stringValue)!= "CITY_RP") || (( property.FindPropertyRelative("_selectedLayerName").stringValue)!= "CITY_RS")){
				UnityEngine.Debug.Log("fjsdfdsfkdjfsklflsjdfskfjslkdjflsdkfjlfkslfkdl");
				displayNames.RemoveAt(2);
				displayNames.RemoveAt(3);
			}*/
