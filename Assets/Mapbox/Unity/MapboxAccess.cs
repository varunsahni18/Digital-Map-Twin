...
namespace Mapbox.Unity
{
	...
	public class MapboxAccess : IFileSource
	{
		...
		private string _tokenNotSetErrorMessage = "No configuration file found! Configure your access token from the MMIMaps > Setup menu.";
		...
		{
	                var mmiurl = "https://mt1.mapmyindia.com/advancedmaps/v1/"+configuration.AccessToken+"/still_map/16/46894/30386"+".png";
		...
		public MapboxTokenApi TokenValidator
		{
			get
			{
				...
				//UnityEngine.Debug.Log("the config is..............."+_tokenValidator);
